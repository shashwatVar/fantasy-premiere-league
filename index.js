...
var job1 = schedule.scheduleJob({ hour: 18, minute: 27 }, function() {
...
var job2 = schedule.scheduleJob({ hour: 18, minute: 47 }, function() {
...
var job3 = schedule.scheduleJob({ hour: 18, minute: 27 }, function() {
    var user_name = [];
    var user_wins = [];
    var user_draws = [];
    var user_loses = [];
...
var job4 = schedule.scheduleJob({ hour: 18, minute: 27 }, function() {
